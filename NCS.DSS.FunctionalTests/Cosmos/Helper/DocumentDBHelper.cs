...
namespace NCS.DSS.FunctionalTests.Cosmos.Helper
{
...

    {
        ...
        private static Uri _notificationDocumentCollectionUri;
        private static readonly string NotificationDatabaseId = ConfigurationManager.AppSettings["ListenerDatabaseId"];
        private static readonly string NotificationCollectionId = ConfigurationManager.AppSettings["ListenerCollectionId"];
        ...
        //#region NotificationDB

        //public static Uri CreateNotificationDocumentCollectionUri()
        //{
        //    if (_notificationDocumentCollectionUri != null)
        //        return _notificationDocumentCollectionUri;

        //    _notificationDocumentCollectionUri = UriFactory.CreateDocumentCollectionUri(
        //        NotificationDatabaseId, NotificationCollectionId);

        //    return _notificationDocumentCollectionUri;
        //}

        //public static Uri CreateNotificationDocumentUri(Guid notificationId)
        //{
        //    return UriFactory.CreateDocumentUri(NotificationDatabaseId, NotificationCollectionId, notificationId.ToString()); ;
        //}
