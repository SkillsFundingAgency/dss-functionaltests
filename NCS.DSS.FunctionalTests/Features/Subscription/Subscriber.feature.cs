...
namespace NCS.DSS.FunctionalTests.Features.Subscription
{
    ...
    [NUnit.Framework.DescriptionAttribute("Subscriber")]
    [NUnit.Framework.CategoryAttribute("postV1")]
    public partial class SubscriberFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "Subscriber.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Subscriber", "\tA touchpoint may subscribe to an existing customer.\r\n\tAny updates or new resourc" +
                    "es to that customer will result in a notification to the subscribing touchpoint", ProgrammingLanguage.CSharp, new string[] {
                        "postV1"});
